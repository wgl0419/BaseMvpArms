...
import com.zckj.parking.util.OSUtil;
import com.zckj.parking.util.StatusBarUtil;
...
public class ActivityLifecycleCallbacksImpl implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
        StatusBarUtil.setStatusBarColor(activity, R.color.white_color);
        StatusBarUtil.statusBarLightMode(activity, OSUtil.getRomType());
    }
