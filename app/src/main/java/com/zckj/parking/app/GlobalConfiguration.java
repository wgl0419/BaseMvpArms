...
import com.zckj.parking.BuildConfig;
import com.zckj.parking.http.HttpResponse;
import com.zckj.parking.http.ResultJsonDeser;
import com.zckj.parking.mvp.model.api.Api;
...
//                .executorService(Executors.newCachedThreadPool())
                ...
                .gsonConfiguration((context1, gsonBuilder) -> {//这里可以自己自定义配置 Gson 的参数
                    gsonBuilder
                            ...
                            .registerTypeHierarchyAdapter(HttpResponse.class, new ResultJsonDeser())
